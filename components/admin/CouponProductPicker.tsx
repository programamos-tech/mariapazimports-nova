      ...
      {restrict ? (
        <>
          ...
          <div>
            ...
            />
            {showHits.length > 0 ? (
              <ul className="mt-2 max-h-44 overflow-y-auto rounded-lg border border-zinc-200 bg-white text-sm shadow-sm">
                {showHits.map((h) => (
                  <li
                    key={h.id}
                    className="flex items-center justify-between gap-2 border-b border-zinc-100 px-3 py-2 last:border-b-0"
                  >
                    ...
                    <button
                      ...
                      className="shrink-0 rounded-md bg-zinc-900 px-2.5 py-1 text-xs font-semibold text-white disabled:cursor-not-allowed disabled:opacity-40"
                    >
                      Agregar
                    </button>
                  </li>
            ...
            <div>
              ...
              <ul className="flex flex-wrap gap-2">
                {selected.map((p) => (
                  <li
                    key={p.id}
                    className="inline-flex max-w-full items-center gap-1 rounded-full border border-zinc-200 bg-zinc-50 py-1 pl-2.5 pr-1 text-xs text-zinc-800"
                  >
                    ...
                    <button
                      ...
                      className="inline-flex size-6 shrink-0 items-center justify-center rounded-full text-zinc-500 hover:bg-zinc-200 hover:text-zinc-800"
