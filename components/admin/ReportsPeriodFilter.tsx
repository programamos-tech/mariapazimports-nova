...
const panelClass =
  "absolute right-0 top-[calc(100%+0.35rem)] z-40 w-[min(100vw-1.5rem,22rem)] rounded-xl border border-stone-200 bg-white p-4 shadow-[0_16px_48px_-24px_rgba(0,0,0,0.35)]";
  ...
  return (
    <div ref={wrapRef} className="relative flex flex-wrap items-center gap-2">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="inline-flex items-center gap-2 rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm font-medium text-stone-800 shadow-[0_1px_2px_0_rgb(28_25_23/0.04)] transition hover:border-stone-300 hover:bg-stone-50"
        aria-expanded={open}
      ...
      >
        ...
        <svg
          viewBox="0 0 24 24"
          className={`size-4 shrink-0 text-stone-500 transition ${open ? "rotate-180" : ""}`}
          fill="none"
          stroke="currentColor"
          strokeWidth={2}
          aria-hidden
      ...
      <button
        ...
        className="rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm text-stone-600 shadow-[0_1px_2px_0_rgb(28_25_23/0.04)] transition hover:border-stone-300 hover:bg-stone-50"
      >
        Actualizar
      </button>
      ...
      {open ? (
        <div className={panelClass} role="dialog" aria-label="Filtro de periodo">
          <button
            type="button"
            onClick={applyToday}
            className="w-full rounded-lg bg-stone-900 px-3 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-stone-800"
          >
            Hoy
          </button>
          ...
          {tab === "day" ? (
            <div className="mt-4 space-y-3">
              ...
              <button
                ...
                className="w-full rounded-lg border border-stone-200 bg-white px-3 py-2.5 text-sm font-semibold text-stone-900 transition hover:bg-stone-50"
              >
                Aplicar
              </button>
            </div>
