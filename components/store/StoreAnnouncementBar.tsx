...
function AnnouncementSegment({ isDuplicate }: { isDuplicate: boolean }) {
  return (
    <span
      className={`inline-flex shrink-0 items-center gap-x-2 whitespace-nowrap py-2.5 pr-3 text-[11px] font-medium uppercase leading-snug tracking-[0.14em] text-stone-800 sm:gap-x-2.5 sm:pr-4 sm:text-xs sm:tracking-[0.16em] ${
