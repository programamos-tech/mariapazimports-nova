    ...
    <div className="border-b border-stone-200/90 bg-white">
      <div className="relative mx-auto max-w-5xl px-4 py-2.5 pr-11 sm:pr-12">
        ...
        <button
          type="button"
          onClick={close}
          className="absolute right-3 top-1/2 inline-flex size-8 -translate-y-1/2 items-center justify-center rounded-none text-stone-600 transition hover:text-stone-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-stone-400/35 focus-visible:ring-offset-2 sm:right-4"
